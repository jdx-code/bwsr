...
const VendorSignup = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const url = "http://localhost:5000/api/users/register-faculty";
    const options = {
      method: "POST",
      headers: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-pink-300 py-12 px-4 sm:px-6 lg:px-8">
